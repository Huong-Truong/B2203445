...
class MonhocController extends AppController
{
    ...
    {
        $query = $this->Monhoc->find();
        $monhoc = $this->paginate($query);
    ...
    {
        $monhoc = $this->Monhoc->get($id, contain: ['Lopmonhoc']);
        $this->set(compact('monhoc'));
    }
    ...
    public function add()
    {
        $monhoc = $this->Monhoc->newEmptyEntity();
    ...
    {
        $monhoc = $this->Monhoc->get($id, contain: []);
